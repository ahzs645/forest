...
- Name: tui-browser-onboarding.spec.js >> setup smoke stays stable for Field Technician on the coast lane
...
Received string:    "Role-Area BriefingField BriefingFish-bearing ditches, steep creek mouths, and rain-lashed road prisms that can fail between one crew call and the next▸ More context"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.tui-field-main')
    9 × locator resolved to <div class="tui-field-main">…</div>
      - unexpected value "Role-Area BriefingField BriefingFish-bearing ditches, steep creek mouths, and rain-lashed road prisms that can fail between one crew call and the next▸ More context"
      ...
      - complementary [ref=e13]:
        ...
        - generic [ref=e17]:
          ...
          - generic [ref=e39]:
            ...
            - generic [ref=e41]: Field Technician
          - generic [ref=e42]:
            - generic [ref=e43]: Area
            - generic [ref=e44]: Vancouver Island Coast
      - generic [ref=e45]:
        - generic [ref=e46]:
          - generic [ref=e47]: Field Radio
          - generic [ref=e50]:
            - generic [ref=e51]: Role-Area Briefing
            - generic [ref=e52]: Field Briefing
            - paragraph [ref=e53]: Fish-bearing ditches, steep creek mouths, and rain-lashed road prisms that can fail between one crew call and the next
            - button "▸ More context" [ref=e54] [cursor=pointer]
        - generic [ref=e55]:
          - generic [ref=e56]:
            - generic [ref=e57]: How do you want to respond?
            - generic [ref=e58]: ↑↓ · Enter
          - paragraph [ref=e59]: SituationFish-bearing ditches, steep creek mouths, and rain-lashed road prisms that can fail between one crew call and the next
          - generic [ref=e60]:

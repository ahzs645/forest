...
- Name: tui-browser-onboarding.spec.js >> setup smoke stays stable for Silviculture Supervisor in the drybelt lane
...
Received string:    "Role-Area BriefingOperations BriefingDrybelt ground where drought stress, grass competition, and browse can turn a simple planting program into repeated follow-up work▸ More context"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.tui-field-main')
    9 × locator resolved to <div class="tui-field-main">…</div>
      - unexpected value "Role-Area BriefingOperations BriefingDrybelt ground where drought stress, grass competition, and browse can turn a simple planting program into repeated follow-up work▸ More context"
      ...
      - complementary [ref=e13]:
        ...
        - generic [ref=e17]:
          ...
          - generic [ref=e39]:
            ...
            - generic [ref=e41]: Silviculture Supervisor
          - generic [ref=e42]:
            - generic [ref=e43]: Area
            - generic [ref=e44]: Okanagan/Shuswap Drybelt
      - generic [ref=e45]:
        - generic [ref=e46]:
          - generic [ref=e47]: Field Radio
          - generic [ref=e50]:
            - generic [ref=e51]: Role-Area Briefing
            - generic [ref=e52]: Operations Briefing
            - paragraph [ref=e53]: Drybelt ground where drought stress, grass competition, and browse can turn a simple planting program into repeated follow-up work
            - button "▸ More context" [ref=e54] [cursor=pointer]
        - generic [ref=e55]:
          - generic [ref=e56]:
            - generic [ref=e57]: How do you want to respond?
            - generic [ref=e58]: ↑↓ · Enter
          - paragraph [ref=e59]: SituationDrybelt ground where drought stress, grass competition, and browse can turn a simple planting program into repeated follow-up work
          - generic [ref=e60]:

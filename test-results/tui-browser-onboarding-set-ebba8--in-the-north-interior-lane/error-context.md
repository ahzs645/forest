...
- Name: tui-browser-onboarding.spec.js >> setup smoke stays stable for Strategic Planner in the north/interior lane
- Location: tests/e2e/tui-browser-onboarding.spec.js:64:3
...
Received string:    "Role-Area BriefingLandscape BriefingBeetle-killed pine stands where wildfire resilience, mixedwood recovery, and nearby community evacuation routes all compete for the same hectares▸ More context"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.tui-field-main')
    9 × locator resolved to <div class="tui-field-main">…</div>
      - unexpected value "Role-Area BriefingLandscape BriefingBeetle-killed pine stands where wildfire resilience, mixedwood recovery, and nearby community evacuation routes all compete for the same hectares▸ More context"
      ...
      - complementary [ref=e13]:
        ...
        - generic [ref=e17]:
          ...
          - generic [ref=e39]:
            ...
            - generic [ref=e41]: Strategic Planner
          - generic [ref=e42]:
            - generic [ref=e43]: Area
            - generic [ref=e44]: Fraser Plateau Uplands
      - generic [ref=e45]:
        - generic [ref=e46]:
          - generic [ref=e47]: Field Radio
          - generic [ref=e50]:
            - generic [ref=e51]: Role-Area Briefing
            - generic [ref=e52]: Landscape Briefing
            - paragraph [ref=e53]: Beetle-killed pine stands where wildfire resilience, mixedwood recovery, and nearby community evacuation routes all compete for the same hectares
            - button "▸ More context" [ref=e54] [cursor=pointer]
        - generic [ref=e55]:
          - generic [ref=e56]:
            - generic [ref=e57]: How do you want to respond?
            - generic [ref=e58]: ↑↓ · Enter
          - paragraph [ref=e59]: SituationBeetle-killed pine stands where wildfire resilience, mixedwood recovery, and nearby community evacuation routes all compete for the same hectares
          - generic [ref=e60]:
